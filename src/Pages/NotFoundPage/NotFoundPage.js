    ...
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        ...
        <div className="block md:flex lg:flex justify-center items-center">
          <NavLink to="/">
            <button
              className="flex items-center space-x-2 bg-teal-600 hover:bg-teal-700 text-gray-100 px-4 py-2 rounded transition duration-150 min-w-[178px] mr-0 md:mr-2 lg:mr-3 mb-3 md:mb-0 lg:mb-0"
              title="Return Home"
            >
              <svg
          ...
          <button
            ...
            className="flex items-center space-x-2 bg-teal-600 hover:bg-teal-700 text-gray-100 px-4 py-2 rounded transition duration-150 min-w-[178px]"
            title="Go To Back"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
